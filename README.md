# Engineer 'Kim Jong-yeon'



## 📌 Summary

기술적 도전과 성장을 즐기며, 탄탄한 백엔드 이해도를 갖춘 주니어 프론트엔드 엔지니어 **김종연**입니다.
...
- **근거 있는 기술 도입:** 새로운 스택을 선택할 때 항상 '왜(Why)'에 집중하며, 프로젝트의 목적에 가장 부합하는 도구를 선택합니다.

- **클린 코드 & 테스트:** 유지보수가 쉬운 가독성 좋은 코드와 안정성을 담보하는 테스트 코드 작성을 지향합니다.

- **T-Shaped 인재:** 백엔드(Spring)와 인프라(AWS)에 대한 이해를 바탕으로 효율적인 API 설계와 협업이 가능합니다.



## 📚 Reference

- 👨‍💻 [GitHub Repository](https://github.com/kwhddus0214@naver.com)

- 📧 Contact: whddus0214@gmail.com



## 🔥 Test

- [Fisa CE 6기] 프로젝트 진행 및 기술 스택 내재화 중

- [n8n Project] 워크플로우 자동화를 통한 업무 효율 개선 테스트 진행 중
